...
thematicDashboardModule.constant('apiConfig', {
    baseUrl: 'https://trainingonline.gov.in/staging'
});

thematicDashboardModule.service('thematicDashboardService', ['$http', 'apiConfig', function ($http, apiConfig) {
    var service = {};

    service.findThemeName = function() {
        return $http.get(apiConfig.baseUrl + "/count/tmpws/themeName", {});
    };

    service.findUploadType = function () {
        return $http.get(apiConfig.baseUrl + "/count/tmpws/uploadType", {});
    };

    service.findUploadedDetails = function (themeId, docType, keyword, limit, languageId) {
        return $http.get(apiConfig.baseUrl + "/count/tmpws/themeUploadedDetails/themeId=" + themeId + "&docType=" + docType + "&keyword=" +
            keyword + "&limit=" + limit + "&languageId=" + languageId, {});
    };

    service.findLanguage = function () {
        return $http.get(apiConfig.baseUrl + "/count/tmpws/language", {});
    };
